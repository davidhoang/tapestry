...
export function useUpdateList() {
  ...
  return useMutation({
    mutationFn: async (data: { id: number; name?: string; description?: string; summary?: string; isPublic?: boolean; jobDescriptionUrl?: string | null; jobDescriptionOgData?: object | null }) => {
