    ...
    <div className="min-h-screen bg-background">
      ...
      <div className={`flex flex-col lg:flex-row h-screen pt-16 ${currentRecommendations.length > 0 ? 'lg:pr-96' : ''}`}>
        ...
        {currentRecommendations.length > 0 && (
          <div className="lg:w-96 lg:fixed lg:right-0 lg:top-16 lg:bottom-0 bg-background border-t lg:border-t-0 lg:border-l border-border lg:shadow-lg flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-4 lg:p-6 max-h-80 lg:max-h-none">
