...
- January 16, 2025. Restored Lists functionality for Member role: updated both client and server permissions to grant Members access to Lists feature (canViewLists, canCreateLists, canEditLists, canShareLists), responding to user request to restore Lists navigation functionality
